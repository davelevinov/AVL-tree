...
public class TerminationFactory {
	...
	public Tank[] listTerminatedTanks(){
		Tank[] TerminatedTanks = T2.inorder();
		return TerminatedTanks;
	}
	...
	public Tank[] listNonTerminatedTanks(){
		Tank[] WaitingTerminationTanks = T1.inorder();
		return WaitingTerminationTanks;
	}
	...
	public void dismantleTanks(){
		Tank[] AwaitingTerminationTanks = listNonTerminatedTanks();
		for(int i=0;i<AwaitingTerminationTanks.length;i++){
			T2.insert(AwaitingTerminationTanks[i]);
		}
		this.T1 = new AVLTree();
	}
}
